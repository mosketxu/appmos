    ...
    <div class="p-1 mx-2">
        ...
        <div class="py-0.5 ">
            <div class="flex w-full pt-2 pb-0 pl-2 space-x-2 text-xs font-bold text-gray-500 bg-blue-100 rounded-t-md">
                <div class="hidden md:flex w-1/12 space-x-1 rounded-l-xl">
                ...
                <div class="flex w-11/12 space-x-1">
                    ...
                    <div class="hidden md:w-1/12"><input type="text" value="Subtotal" class="w-full py-1 text-xs font-bold text-gray-500 truncate bg-blue-100 border-0 rounded-md" disabled /></div>
                    <div class="hidden md:w-1/12"><input type="text" value="Iva" class="w-full py-1 text-xs font-bold text-right text-gray-500 truncate bg-blue-100 border-0 rounded-md" disabled /></div>
            ...
            @forelse ($detalles as $detalle)
                ...
                <div class="flex w-full pl-2 text-xs text-gray-500 {{ $loop->even ? 'bg-yellow-50' : 'bg-green-50' }}">
                    <div class="hidden md:flex w-1/12 space-x-1 pt-0 mt-0 {{ $loop->even ? 'bg-yellow-50' : 'bg-green-50' }}" wire:loading.class.delay="opacity-50">
